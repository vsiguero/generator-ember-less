...
describe('subgenerators', function () {
  ...
  it('router', function (done) {
    this.router = {};
    this.router = helpers.createGenerator('ember-less:router', ['../../router']);
  ...
  it('view', function (done) {
    this.view = {};
    this.view = helpers.createGenerator('ember-less:view', ['../../view'], 'user');
  ...
  it('controller', function (done) {
    this.controller = {};
    this.controller = helpers.createGenerator('ember-less:controller', ['../../controller','../../view','../../router'], 'user');
